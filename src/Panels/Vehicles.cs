...
namespace Top_Seguros_Brasil_Desktop.src.Panels
{
    public partial class Vehicles : BasePanel
    {
        ...
        private async void SubmitPanelSetup(string id)
        {
            ...
            submitButton.Click += async (sender, e) =>
            {
                ...
                await PostVehicle(vehicle, null);
            };
        ...
        protected async Task PostVehicle(Veiculo vehicleData, EventHandler? e)
        {
            await vehiclesDataTable.Post<CustomerInsertResponse>(vehicleData);
        ...
        private async Task SubmitPanelSetup<Type>(string id)
        {
            ...
            submitButton.Click += async (sender, e) =>
            {
                ...
                (
                    ...
                    uso: usageField.Text,
                    sinistrado: checkBox.Checked,
                    idCliente: vehicleBody.id_cliente.Value
                );
